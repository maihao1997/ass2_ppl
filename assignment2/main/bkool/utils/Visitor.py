...
class Visitor(ABC):
    ...
    def visitConstDecl(self, param):
        pass
    @abstractmethod
    def visitClassDecl(self, param):
        pass
    @abstractmethod
    def visitStatic(self, param):
        pass
    @abstractmethod
    def visitInstance(self, param):
        pass
    @abstractmethod
    def visitMethodDecl(self, param):
        pass
    @abstractmethod
    def visitAttributeDecl(self, param):
        pass
    @abstractmethod
    ...
    def visitStringLiteral(self, param):
        pass
    @abstractmethod
    def visitNullLiteral(self, param):
        pass
    @abstractmethod
    def visitSelfLiteral(self, param):
        pass    
